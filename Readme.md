...
*This tool has been modified from the original version authored by Crowdstrike; this version runs the same tooling but instead of targeting the commercial Azure and Office 365 endpoints, it targets Azure Government and Office 365 GCC High. No other changes have been made*
